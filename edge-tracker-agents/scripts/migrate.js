...
const TABLES = [
  ...
  'alert_log', 'subscribers', 'ev_opportunities', 'arb_opportunities', 'line_signals', 'opp_results', 'research_notes', 'fair_line_log', 'tennis_markets', 'tennis_fatigue', 'tennis_matchups',
];
