...
import nflQb from '../agents/nfl-qb/index.js';
...
const AGENTS = [
  ...
  publicFade, nflPower, nflWinTotals, nflSchedule, nflProps, nflTotals, nflInactives, nflLineMove, nflDerivatives, nflPace, nflQb, predMarket, watchdog, digest,
];
