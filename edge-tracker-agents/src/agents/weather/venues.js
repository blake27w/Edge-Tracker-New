...
export const VENUES = {
  ...
  'Atlanta Braves': { lat: 33.89, lon: -84.47, dome: false, venue: 'Truist Park' },
  'Baltimore Orioles': { lat: 39.28, lon: -76.62, dome: false, venue: 'Camden Yards' },
  'Boston Red Sox': { lat: 42.35, lon: -71.10, dome: false, venue: 'Fenway Park' },
  'Chicago Cubs': { lat: 41.95, lon: -87.66, dome: false, venue: 'Wrigley Field' },
  'Chicago White Sox': { lat: 41.83, lon: -87.63, dome: false, venue: 'Rate Field' },
  'Cincinnati Reds': { lat: 39.10, lon: -84.51, dome: false, venue: 'Great American Ball Park' },
  'Cleveland Guardians': { lat: 41.50, lon: -81.69, dome: false, venue: 'Progressive Field' },
  'Colorado Rockies': { lat: 39.76, lon: -104.99, dome: false, venue: 'Coors Field' },
  'Detroit Tigers': { lat: 42.34, lon: -83.05, dome: false, venue: 'Comerica Park' },
  'Houston Astros': { lat: 29.76, lon: -95.36, dome: true, venue: 'Daikin Park' },
  'Kansas City Royals': { lat: 39.05, lon: -94.48, dome: false, venue: 'Kauffman Stadium' },
  'Los Angeles Angels': { lat: 33.80, lon: -117.88, dome: false, venue: 'Angel Stadium' },
  'Los Angeles Dodgers': { lat: 34.07, lon: -118.24, dome: false, venue: 'Dodger Stadium' },
  ...
  'Minnesota Twins': { lat: 44.98, lon: -93.28, dome: false, venue: 'Target Field' },
  'New York Mets': { lat: 40.76, lon: -73.85, dome: false, venue: 'Citi Field' },
  'New York Yankees': { lat: 40.83, lon: -73.93, dome: false, venue: 'Yankee Stadium' },
  'Athletics': { lat: 38.58, lon: -121.51, dome: false, venue: 'Sutter Health Park' },
  'Oakland Athletics': { lat: 38.58, lon: -121.51, dome: false, venue: 'Sutter Health Park' },
  'Philadelphia Phillies': { lat: 39.91, lon: -75.17, dome: false, venue: 'Citizens Bank Park' },
  'Pittsburgh Pirates': { lat: 40.45, lon: -80.01, dome: false, venue: 'PNC Park' },
  'San Diego Padres': { lat: 32.71, lon: -117.16, dome: false, venue: 'Petco Park' },
  'San Francisco Giants': { lat: 37.78, lon: -122.39, dome: false, venue: 'Oracle Park' },
  'Seattle Mariners': { lat: 47.59, lon: -122.33, dome: false, venue: 'T-Mobile Park' },
  'St. Louis Cardinals': { lat: 38.62, lon: -90.19, dome: false, venue: 'Busch Stadium' },
  'Tampa Bay Rays': { lat: 27.98, lon: -82.51, dome: false, venue: 'Steinbrenner Field' },
  ...
  'Washington Nationals': { lat: 38.87, lon: -77.01, dome: false, venue: 'Nationals Park' },
